...
/*
 * Ho va ten: Tong Nguyen Minh Khang
 * MSSV: 21120263
 * Ca: Sang thu 7, Lop: 21_21 He Dieu hanh
 */
...
#define SC_TCPSocketInit  21
#define SC_SocketConnect  22
#define SC_SocketSend   23
#define SC_SocketReceive  24
#define SC_SocketClose 25
#define SC_Add		42
...
/*
 * Initiate an array of TCP sockets connection 
 * (an OpeningSocket object with 20 connections description object) if 
 * Return an id of an available socket if connect successfully, -1 if not
 */
int SocketTCP();

/*
 * Connect to IP ip with port number port
 * with socket id socketid
 * Return 0 if initiate successfully, -1 if not
 */
